...
import { Mic, Zap, Users, Shield, Clock, MessageSquare, ArrowRight, CheckCircle } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50 animate-slide-down">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2 animate-fade-in">
            <span className="text-2xl font-extrabold tracking-tight bg-gradient-to-r from-blue-600 to-blue-400 text-transparent bg-clip-text italic">
              Formify
            </span>
          </div>
          <nav className="hidden md:flex items-center gap-6 animate-fade-in-delay">
            <a href="#features" className="text-slate-600 hover:text-blue-600 transition-colors duration-300">
              Features
            </a>
            <a href="#about" className="text-slate-600 hover:text-blue-600 transition-colors duration-300">
              About
            </a>
            <a href="#industries" className="text-slate-600 hover:text-blue-600 transition-colors duration-300">
              Industries
            </a>
            <Link to="/login">
              <Button
      ...
      <section className="py-20 md:py-32 overflow-hidden relative">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="container mx-auto px-4 h-full relative">
            {/* Form 1 */}
            <div className="absolute top-20 left-10 w-48 h-64 bg-white rounded-lg shadow-lg transform rotate-[-8deg] hover:scale-110 hover:rotate-[-6deg] transition-all duration-500 opacity-20 hover:opacity-30 pointer-events-auto">
            ...
            {/* Form 2 */}
            <div className="absolute top-32 right-16 w-52 h-72 bg-white rounded-lg shadow-lg transform rotate-[12deg] hover:scale-110 hover:rotate-[10deg] transition-all duration-500 opacity-15 hover:opacity-25 pointer-events-auto">
              <div className="p-4 h-full">
            ...
            {/* Form 3 */}
            <div className="absolute bottom-20 left-20 w-44 h-60 bg-white rounded-lg shadow-lg transform rotate-[6deg] hover:scale-110 hover:rotate-[4deg] transition-all duration-500 opacity-20 hover:opacity-30 pointer-events-auto">
              <div className="p-4 h-full">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <Badge variant="secondary" className="mb-4 bg-blue-100 text-blue-800 border-blue-200 animate-bounce-in">
            Voice-Powered Form Filling
          </Badge>
          <h1 className="text-4xl md:text-6xl font-bold text-slate-900 mb-6 leading-tight animate-fade-up">
            Transform Speech into
            <span className="text-blue-600 block animate-fade-up-delay">Structured Data</span>
          </h1>
          <p className="text-xl text-slate-600 mb-8 max-w-3xl mx-auto leading-relaxed animate-fade-up-delay-2">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 animate-fade-up-delay-3">
            <Link to="/register">
              <Button
                size="lg"
                className="bg-blue-600 hover:bg-blue-700 text-lg px-8 py-3 hover:scale-105 transition-all duration-300 group"
              >
                Start Free Trial
          ...
          <div className="flex items-center justify-center gap-8 text-sm text-slate-500 animate-fade-up-delay-4">
      ...
      <section id="about" className="py-20">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-slate-50 rounded-2xl p-8 lg:p-12 animate-slide-left">
              <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-500">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div className="ml-auto flex items-center gap-2">
                    ...
                    <div className="w-16 h-2 bg-blue-200 rounded-full">
                      <div className="h-2 bg-blue-600 rounded-full w-3/4 animate-pulse-wave"></div>
                    </div>
                  </div>
                </div>
      ...
      <section id="industries" className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center">
            <div className="relative w-[600px] h-96 group">
              {/* Legal Paper */}
              <div className="absolute top-10 left-0 w-64 h-80 bg-white rounded-lg shadow-xl border border-slate-200 transform rotate-[-15deg] transition-all duration-500 ease-out legal-paper cursor-pointer z-10">
                <div className="p-6 h-full">
                  ...
                  <div className="space-y-3">
                    <div className="border-b-2 border-orange-600 pb-2 mb-4">
                      <div className="h-2 bg-orange-600 rounded w-1/3"></div>
                    </div>
                    <div className="h-2 bg-slate-200 rounded w-full"></div>
                    <div className="h-2 bg-orange-200 rounded w-3/4"></div>
                    <div className="h-2 bg-slate-200 rounded w-5/6"></div>
                    <div className="mt-4 p-2 bg-orange-50 rounded border-2 border-dashed border-orange-300">
                      <div className="text-center">
                ...
                <div className="p-6 h-full">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="mt-4 grid grid-cols-2 gap-2">
                      <div className="h-6 bg-green-100 rounded border"></div>
                      <div className="h-6 bg-slate-100 rounded border"></div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center animate-fade-up">
          ...
          <div className="flex flex-wrap justify-center gap-8 text-sm text-slate-500 animate-fade-up-delay">
      ...
      {/* Footer */}
      <footer className="bg-slate-900 text-white py-12 animate-slide-up">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-slate-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center animate-fade-up">
